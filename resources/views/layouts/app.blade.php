...
<head>
    ...
    <meta property="og:image" content="{{asset('image/logo_512.png')}}"/>
    <link rel="shortcut icon" href="{{asset('image/title_logo.png')}}" type="image/x-icon">
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="{{asset('image/undraw_profile_1.svg')}}"
                                         alt="...">
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="{{asset('image/undraw_profile_2.svg')}}"
                                         alt="...">
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="{{asset('image/undraw_profile_3.svg')}}"
                                         alt="...">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                         src="{{asset('image/undraw_posting_photo.svg')}}" alt="...">
                                </div>
