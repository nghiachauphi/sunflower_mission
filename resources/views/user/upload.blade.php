...
<script>
    function CreateRowItem(data, stt)
    {
        ...
        {
            link.innerText = "https://nghiacp.site/free_image/" + data.link;
            link.setAttribute("href", "https://nghiacp.site/free_image/" + data.link);
        }
        else
        {
            link.innerText = "https://nghiacp.site/free_image/" + data._id;
    ...
    function CreateRowItem_V2(data, stt)
    {
        ...
        {
            li_link.innerText = "https://nghiacp.site/upload_file/" + data.id_ggdrive;
            li_link.setAttribute("href", "https://nghiacp.site/upload_file/" + data.id_ggdrive);
